/*
  ...
  - You are about to drop the column `is_confirmad` on the `participants` table. All the data in the column will be lost.
  - You are about to drop the column `isConfirmad` on the `trips` table. All the data in the column will be lost.
