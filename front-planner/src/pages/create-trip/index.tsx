...
import { ConfrimTripModal } from "./confirm-trip-modal";
...
export function CreateTripPage() {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-[url('/bg.png')] bg-no-repeat bg-center bg-size-[900px]">
